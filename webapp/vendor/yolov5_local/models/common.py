...
# Import 'ultralytics' package without mutating the runtime environment.
try:
    import ultralytics
    ...
    raise ImportError(
        "TowerScout local YOLOv5 runtime requires the `ultralytics` package. "
        "Install the validated dependencies from `webapp/requirements.txt` and retry."
    ) from exc
