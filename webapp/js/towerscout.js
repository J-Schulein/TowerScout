/**
 * TowerScout Frontend Bundle - Auto-generated
 * Build Date: 2026-02-25T20:20:06.567Z
 * Build Script: webapp/build.js
 * 
 * ⚠️  DO NOT EDIT THIS FILE DIRECTLY
 * Modify source files in webapp/js/src/ directory
 * Then rebuild: node webapp/build.js
 */
...
// ═══════════════════════════════════════════════════════════════════
// MODULE: src/managers/ProviderStateManager.js
// ═══════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════
// MODULE: src/managers/TimerManager.js
// ═══════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════
// MODULE: src/managers/EventListenerManager.js
// ═══════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════
// MODULE: src/managers/ErrorHandler.js
// ═══════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════
// MODULE: src/boundaries/CircleBoundary.js
// ═══════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════
// MODULE: src/boundaries/PolygonBoundary.js
// ═══════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════
// MODULE: src/boundaries/ZipcodeBoundary.js
// ═══════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════
// MODULE: src/providers/GoogleMap.js
// ═══════════════════════════════════════════════════════════════════

// Provider: Google Maps - Stage 3 (Placeholder)
// Will be extracted in Stage 3

(function() {
  'use strict';
  // Google Maps provider code will be extracted here in Stage 3
  console.log('✅ GoogleMap module loaded (Stage 3 pending)');
})();


// ═══════════════════════════════════════════════════════════════════
// MODULE: src/providers/AzureMap.js
// ═══════════════════════════════════════════════════════════════════

// Provider: Azure Maps - Stage 3 (Placeholder)
// Will be extracted in Stage 3

(function() {
  'use strict';
  // Azure Maps provider code will be extracted here in Stage 3
  console.log('✅ AzureMap module loaded (Stage 3 pending)');
})();


// ═══════════════════════════════════════════════════════════════════
// MODULE: src/providers/providerInit.js
// ═══════════════════════════════════════════════════════════════════

// Provider Initialization - Stage 3 (Placeholder)
// Will be extracted in Stage 3

(function() {
  'use strict';
  // Provider initialization code will be extracted here in Stage 3
  console.log('✅ providerInit module loaded (Stage 3 pending)');
})();


// ═══════════════════════════════════════════════════════════════════
// MODULE: src/providers/providerSwitch.js
// ═══════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════
// MODULE: src/detection/Detection.js
// ═══════════════════════════════════════════════════════════════════

// Detection Class - Stage 4 (Placeholder)
// Will be extracted in Stage 4

(function() {
  'use strict';
  // Detection class code will be extracted here in Stage 4
  console.log('✅ Detection module loaded (Stage 4 pending)');
})();


// ═══════════════════════════════════════════════════════════════════
// MODULE: src/detection/Tile.js
// ═══════════════════════════════════════════════════════════════════

// Tile Class - Stage 4 (Placeholder)
// Will be extracted in Stage 4

(function() {
  'use strict';
  // Tile class code will be extracted here in Stage 4
  console.log('✅ Tile module loaded (Stage 4 pending)');
})();


// ═══════════════════════════════════════════════════════════════════
// MODULE: src/detection/DetectionList.js
// ═══════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════
// MODULE: src/detection/DetectionReview.js
// ═══════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════
// MODULE: src/ui/search.js
// ═══════════════════════════════════════════════════════════════════

// UI: Search - Stage 5 (Placeholder)
// Will be extracted in Stage 5

(function() {
  'use strict';
  // Search UI code will be extracted here in Stage 5
  console.log('✅ search module loaded (Stage 5 pending)');
})();
...
// UI: Export - Stage 5 (Placeholder)
// Will be extracted in Stage 5

(function() {
  'use strict';
  // Export UI code will be extracted here in Stage 5
  console.log('✅ export module loaded (Stage 5 pending)');
})();
...
// UI: Navigation - Stage 5 (Placeholder)
// Will be extracted in Stage 5

(function() {
  'use strict';
  // Navigation UI code will be extracted here in Stage 5
  console.log('✅ navigation module loaded (Stage 5 pending)');
})();


// ═══════════════════════════════════════════════════════════════════
// MODULE: src/utils/coordinates.js
// ═══════════════════════════════════════════════════════════════════

// Utilities: Coordinates - Stage 5 (Placeholder)
// Will be extracted in Stage 5

(function() {
  'use strict';
  // Coordinate utilities will be extracted here in Stage 5
  console.log('✅ coordinates module loaded (Stage 5 pending)');
})();


// ═══════════════════════════════════════════════════════════════════
// MODULE: src/utils/imagery.js
// ═══════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════
// MODULE: src/utils/apiHelpers.js
// ═══════════════════════════════════════════════════════════════════

// Utilities: API Helpers - Stage 5 (Placeholder)
// Will be extracted in Stage 5

(function() {
  'use strict';
  // API helper utilities will be extracted here in Stage 5
  console.log('✅ apiHelpers module loaded (Stage 5 pending)');
})();
