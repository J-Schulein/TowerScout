...
| 9 | `TASK-067` CI Release Gate Tightening | ACTIVE | C (CI / Release Engineering) | 0.5-1 day active slice; 1-2 days full task | `TASK-066` checklist | Active Sprint 06 slice: add pytest/CI timeout safeguards, isolate Flask route-test runtime paths, and remove stale legacy `AGENTS.md/` guidance. Later slices can promote package, digest, manifest, docs/license route, and launcher checks into CI or documented required/manual gates. |
