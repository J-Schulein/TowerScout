...
| `TASK-099` August Dependency Advisory Follow-Up | In progress; remediate alerts `#72-#75`, restore the critical/high gates, and reconcile the default-branch inventory before signing or candidate inclusion |
