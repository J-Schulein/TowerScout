...
**Implementation Head**: `30e30efd62d94bdd9f279f3217f79a52e8609b67`
...
**Local Candidate**: Committed durable-promotion checkpoint `30e30ef`; push,
exact-head workflows, and independent review remain pending. Staging and apply
orchestration are production-shaped but have no installer/repair call site, so
...
Continue from the durable provider staging/apply chain by implementing exact
planned/created orphan handling and terminal mini-journal cleanup without a
glob or unrelated-file deletion. Then use the applied record for generation-8
rollback and add the
