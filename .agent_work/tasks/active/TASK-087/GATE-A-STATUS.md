...
**Implementation Head**: `17d813fe816c309cb9c4a99ac25da6dd37d8aee5`
...
1. **Finish trust-backed exact-target wiring (slices 2-4).** The native
   ...
   provider and retained managed-provider/Podman join are checkpointed. Next,
   construct the package/environment, process-environment, and acceleration
   inputs, compose the final owner, connect the target ahead of confirmation,
   and wire stage-specific revalidation.
