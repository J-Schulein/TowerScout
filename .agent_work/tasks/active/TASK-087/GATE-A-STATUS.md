...
**Implementation Head**: `f0a9d81bf6a8dcdbaea52d108ae3f549cbb7a8bb`
...
1. **Finish trust-backed exact-target wiring (slices 2-4).** The native
   ...
   are checkpointed. Implement the concrete authenticated-input owner, connect
   the resulting target ahead of confirmation, and wire stage-specific
   revalidation.
