...
**Implementation Head**: `1ecfd5ee3aeee094a0fe033f153b729324e45787`
**Validated Exact Head**: `1ecfd5ee3aeee094a0fe033f153b729324e45787`
...
Use the checkpointed authenticated `backup_preparing` intent to add create-only
protected backup-blob persistence, `backup_verified`/`rollback_armed`, full
recovery states, fresh-process
