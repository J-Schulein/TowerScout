...
**Validated Exact Head**: `95ca37d68e2dd5039a28766cba0df51303f93ff4`
...
exact destination verification. Same-call API-error classification, backup,
recovery, cleanup, and cross-protocol scanning remain.
The
...
3. **Build durable recovery and refactor repair (slices 6-7).** Review and
  ...
  checkpointed native pointer adapter to add indeterminate-result reconciliation,
