...
**Implementation Head**: `deee6abbfac70e68b984329a239aa5b22818bca4`
**Validated Exact Head**: `deee6abbfac70e68b984329a239aa5b22818bca4`
...
blobs and durable generation 3 `rollback_armed`. Active pointer selection, full
recovery action, cleanup-pending retention, and cross-protocol scanning remain.
The
...
Use the checkpointed authenticated `rollback_armed` state to add active pointer
selection, full recovery states, fresh-process
idempotent recovery, verified rollback, cleanup-pending retention, and cross-
...
Planning estimate from `deee6ab`: one substantive Gate A implementation/proof
