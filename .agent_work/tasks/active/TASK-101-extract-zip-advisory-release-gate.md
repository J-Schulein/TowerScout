...
**Test Status**: PASS locally; exact-head GitHub checks remain open
...
- [ ] The pushed reconciliation head passes required CI/CD and all three
  Task-087 jobs.
- [ ] A subsequent governance head records Task-101 complete and Task-087
  explicitly resumed, then passes its own exact-head checks before new work.
